...
<div class="portlet box green">
    <div class="portlet-title">
        ...
        <div class="actions">
			<a class="btn btn-circle btn-icon-only btn-default" href="<c:url value='/admin/tuser/get?mid='/>${mid}">
				<i class="icon-cloud-upload"></i>
			</a>
    	</div>
    </div>
    <div class="portlet-body form">
        <form class="form-horizontal" id="editForm" method="post" action="<c:url value='/admin/tuser/add'/>" autocomplete="off">
        	<input type="hidden" name="mid" class="form-control" value="${mid}">
			<div class="form-body">
<!-- 	            <div class="form-group"> -->
<!-- 	                <label class="col-md-1 control-label" for="userId">用户编号</label> -->
<!-- 	                <div class="col-md-4"> -->
<%-- 	                    <input type="text" placeholder="用户编号" name="userId" value="${user.userId}" class="form-control"> </div> --%>
<!-- 	            </div> -->
	
	            <div class="form-group">
	                <label class="col-md-1 control-label" for="username">用户帐号</label>
	                <div class="col-md-4">
	                    <input type="text" placeholder="用户帐号" name="username" class="form-control" onblur="valiUserName();"> </div>
	            </div>
	            
	            <div class="form-group">
	                <label class="col-md-1 control-label" for="name">真实姓名</label>
	                <div class="col-md-4">
	                    <input type="text" placeholder="真实姓名" name="name" class="form-control"> </div>
	            </div>
	
	            <div class="form-group">
	                <label class="col-md-1 control-label" for="nick">昵&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;称</label>
	                <div class="col-md-4">
	                    <input type="text" placeholder="昵&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;称" name="nick" class="form-control"> </div>
	            </div>
	                ...
	                <div class="col-md-4">
	                    <div id="uploader-single">
	                        <div style="width: 150px; height: 100px;" class="thumbnail" id="filelist">
	                            <img src="${applicationScope.commConfig['img_comm_url'] }${user.avatar }" style="width: 150px; height: 90px;" alt="" id="imgUrl2" name="imgUrl2" >
	                        </div>
	                        <div id="singleBtn">选择图片</div>
	                    </div>
	                </div>
	                <input type="hidden" name="avatar" id="imgUrl" value=""/>
	            </div>
	
	            <div class="form-group">
	                <label class="col-md-1 control-label" for="idcard">身&nbsp;&nbsp;份&nbsp;&nbsp;证</label>
	                <div class="col-md-4">
	                    <input type="text" maxlength="18" placeholder="身&nbsp;&nbsp;份&nbsp;&nbsp;证" name="idcard" class="form-control"> </div>
	            </div>
	
	            <div class="form-group">
	                <label class="col-md-1 control-label" for="email">邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;箱</label>
	                <div class="col-md-4">
	                    <input type="text" placeholder="邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;箱" name="email" class="form-control">
	                </div>
	            </div>
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-md-4">
	                    <input type="text" maxlength="11" placeholder="手&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;机" name="mobile" class="form-control">
	                </div>
	            </div>
...
<script type="text/javascript">
	...
	function valiUserName(){
		...
		if(userName.length>0){
			...
			$.post("<c:url value='/admin/tuser/valiUserRepeat'/>",formData,function(data){
        ...
        form1.validate({
            ...
            submitHandler : function(form) {
                ...
                if(confirm("你确定提交吗！")) {
                	...
                	$.post("<c:url value='/admin/tuser/add'/>",formData,function(data){
                		var dat = $.parseJSON( data );
                	    alert(dat.msg);
                	    if(dat.result){
                	    	window.location.href = "<c:url value='/admin/tuser/get?mid="+mid+"'/>";
                	    }
                	});
                }
            }
